...
class DenseNet(nn.Module):
    def __init__(self, block, nblocks, growth_rate=12, reduction=0.5, num_classes=10, variation=0):
...
def DenseNet121(variation=0):
    return DenseNet(Bottleneck, [6,12,24,16], growth_rate=32, variation=variation)
